...
<div class="max-w-2xl mx-auto">
    <x-ui:card>
        <x-ui:card-header>
            <x-ui:card-title>Tambah Kegiatan</x-ui:card-title>
        </x-ui:card-header>
        <x-ui:card-content>
            <form method="POST" action="{{ route('kegiatan.store') }}" class="space-y-4">
                ...
                <x-ui:field>
                    ...
                    <x-ui:input type="text" name="nama_kegiatan" required class="w-full" />
                </x-ui:field>
                ...
                <x-ui:field>
                    ...
                    <x-ui:input type="date" name="tanggal" required class="w-full" />
                </x-ui:field>
                
                <x-ui:field>
                    <x-ui:field-label>Deskripsi</x-ui:field-label>
                    <x-ui:textarea name="deskripsi" class="w-full" rows="4"></x-ui:textarea>
                </x-ui:field>
