...
<div class="max-w-2xl mx-auto">
    <x-ui:card>
        <x-ui:card-header>
            <x-ui:card-title>Tambah Anggota</x-ui:card-title>
        </x-ui:card-header>
        <x-ui:card-content>
            <form method="POST" action="{{ route('admin.anggota.store') }}" class="space-y-4">
                ...
                <x-ui:field>
                    ...
                    <x-ui:input type="text" name="nama" required class="w-full" />
                </x-ui:field>
                
                <x-ui:field>
                    <x-ui:field-label>NIM</x-ui:field-label>
                    <x-ui:input type="text" name="nim" required class="w-full" />
                </x-ui:field>
                
                <div class="grid grid-cols-2 gap-4">
                    <x-ui:field>
                        <x-ui:field-label>Kelas</x-ui:field-label>
                        <x-ui:input type="text" name="kelas" required class="w-full" />
                    </x-ui:field>
                    <x-ui:field>
                        <x-ui:field-label>Prodi</x-ui:field-label>
                        <x-ui:input type="text" name="prodi" required class="w-full" />
                    </x-ui:field>
                </div>
                
                <x-ui:field>
                    <x-ui:field-label>Jurusan</x-ui:field-label>
                    <x-ui:input type="text" name="jurusan" required class="w-full" />
                </x-ui:field>
